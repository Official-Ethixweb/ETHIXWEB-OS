...
export const DASHBOARD_WIDGETS: DashboardWidgetDef[] = [
  { id: "kpi-overview", title: "KPI overview", defaultLayout: { x: 0, y: 0, w: 12, h: 9 }, minH: 4 },
  { id: "task-overview", title: "Task overview", defaultLayout: { x: 0, y: 9, w: 12, h: 9 }, minH: 4 },
  { id: "finance-kpis", title: "Finance KPIs", permissionAnyOf: ["finance.view"], defaultLayout: { x: 0, y: 18, w: 12, h: 9 }, minH: 4 },
  { id: "team-pulse", title: "Team pulse", defaultLayout: { x: 0, y: 15, w: 12, h: 6 }, minH: 5 },
  { id: "upcoming-events", title: "Upcoming birthdays & anniversaries", defaultLayout: { x: 0, y: 21, w: 8, h: 8 }, minW: 4, minH: 5 },
  { id: "mini-calendar", title: "Calendar", defaultLayout: { x: 8, y: 21, w: 4, h: 8 }, minW: 3, minH: 5 },
